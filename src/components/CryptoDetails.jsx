...
if(isFetching) return "Loading..."
  ...
  return (
    ...
    <Col className='coin-heading-container'>
      ...
      <p>
      {data?.data?.coin?.name} live price in US dollars. View value statistics, market cap and supply.
      </p>
    </Col>
    <Select 
        defaultValue="7d" 
        ...
        <LineChart data={data} coinPrice={millify(data?.data?.coin?.price)} coinName={data?.data?.coin?.name}/>
        <Col className='stats-container'>
          <Col className='coin-value-statics'>
            <Col className='coin-value-statis-heading'>
